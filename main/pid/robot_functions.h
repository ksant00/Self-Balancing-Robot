...
// Sonar pins
#define sonar1_echo_pin 6 // Right Sonar Echo Pin
#define sonar1_trig_pin 7 // RIght Sonar Trigger Pin
#define sonar2_echo_pin 8 // Left Sonar Echo Pin
#define sonar2_trig_pin 9 // Left Sonar Trigger Pin
...
class app_controls {
    public: 
        ...
        bool backwards;
        bool autopilot;
        short int autopilot_count;
        
        app_controls(void);
        void update_movement(void);
        void update_stop(void);
        void update_extra(int temp);
